...
def main() -> None:
    ...
    parser.add_argument("--model-path", default="/data0/pretrained/Sa2VA-InternVL3-2B")
    ...
    from sa2va_chat_mem import Sa2VAChatMem
    import run as eval_run

    supported_VLM["Sa2VA-InternVL3-2B-LOCAL-MEM"] = partial(
        Sa2VAChatMem, model_path=args.model_path
    )
